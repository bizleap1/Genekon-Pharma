    ...
    <section className="py-6 sm:py-8 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
          ...
          <div className="rounded-2xl border border-[#E7ECEF] bg-[#FAFCFB] p-5 sm:p-6 flex flex-col justify-between hover:border-[#25D366]/40 hover:bg-white hover:shadow-sm transition-all">
            <div>
              <div className="w-11 h-11 rounded-xl bg-[#25D366]/15 text-[#25D366] flex items-center justify-center mb-4">
            ...
            <div className="mt-6 pt-4 border-t border-[#E7ECEF]">
              <a
                href="https://wa.me/917666168147?text=Hi%20GENEKON,%20I%20need%20assistance%20with%20my%20medicine%20order."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-[#25D366] hover:bg-[#20ba59] text-white text-xs sm:text-sm font-bold shadow-xs transition-colors cursor-pointer select-none"
              >
                <WhatsAppIcon size={18} variant="monochrome" className="text-white" />
                <span>Message on WhatsApp (+91 7666168147)</span>
              </a>
            </div>
          </div>
