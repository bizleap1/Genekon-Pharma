...
export const HealthcareHelpSection: React.FC = () => {
  return (
    <section className="py-6 sm:py-10 bg-white">
      <Container>
        <div className="relative rounded-3xl border border-[#D0E3F5] bg-gradient-to-r from-[#EBF4FB] via-[#F0F6FC] to-[#E4F0F9] p-7 sm:p-10 lg:p-12 overflow-hidden shadow-xs">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 flex flex-col justify-center max-w-2xl">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/90 border border-[#D0E3F5] text-brand-primary text-xs font-bold uppercase tracking-wider mb-3 shadow-2xs w-fit">
                <HelpCircle className="w-3.5 h-3.5" />
                <span>PHARMACIST ASSISTANCE DESK</span>
              </div>

              <h2 className="font-serif text-2xl sm:text-3xl lg:text-[38px] text-brand-primary tracking-tight leading-tight">
                Need Help Finding The Right <br className="hidden sm:inline" />
                <span className="text-brand-secondary">Healthcare Product?</span>
              </h2>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 bg-brand-primary hover:bg-brand-secondary text-white text-xs sm:text-sm font-bold px-6 py-3.5 rounded-full transition-all shadow-sm hover:scale-[1.02]"
                >
                ...
                <a
                  href="tel:7666168147"
                  className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-brand-primary border border-[#D0E3F5] text-xs sm:text-sm font-bold px-5 py-3.5 rounded-full transition-colors shadow-2xs"
                >
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              <div className="rounded-2xl border border-[#D0E3F5] bg-white/90 backdrop-blur-xs p-5 shadow-2xs space-y-3.5 text-xs text-brand-primary">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-[#D0E3F5]">
                  <div className="w-8 h-8 rounded-xl bg-[#EBF3FC] text-brand-primary flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-[#D0E3F5]">
                  <div className="w-8 h-8 rounded-xl bg-[#EBF3FC] text-brand-primary flex items-center justify-center shrink-0">
                    <WhatsAppIcon size={16} variant="monochrome" className="text-brand-primary" />
                  </div>
                  <div>
