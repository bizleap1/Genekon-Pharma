...
export const PrescriptionSection: React.FC = () => {
  ...
  return (
    <section className="py-8 sm:py-12 bg-white">
      <Container>
        <div className="relative rounded-3xl border border-[#D0E3F5] bg-gradient-to-br from-[#F5F9FE] via-[#EBF4FB]/70 to-[#F0F6FC] p-6 sm:p-10 lg:p-12 shadow-xs overflow-hidden">
          
          {/* Top Headline & Intro */}
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-8 border-b border-[#D0E3F5]">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#D0E3F5] text-brand-primary text-xs font-bold uppercase tracking-wider mb-3 shadow-2xs">
              ...
              <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl text-brand-primary tracking-tight leading-tight">
                ...
                <span className="text-brand-secondary">Prescription Upload</span>
              </h2>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
              ...
              >
                <button
                  type="button"
                  className="inline-flex items-center justify-center gap-2 bg-brand-primary hover:bg-brand-secondary text-white text-xs sm:text-sm font-bold px-6 py-3.5 rounded-full transition-all shadow-sm hover:scale-[1.02] cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6 mt-8 relative">
            {STEPS.map((s, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`group relative rounded-2xl border border-[#D0E3F5] bg-white p-6 shadow-2xs ${s.borderHover} hover:shadow-md transition-all duration-200 flex flex-col justify-between`}
                >
                  <div>
                  ...
                  <div className="mt-5 pt-3 border-t border-[#D0E3F5] flex items-center justify-between text-[11px] font-bold text-brand-primary">
          ...
          <div className="mt-8 pt-6 border-t border-[#D0E3F5] flex flex-wrap items-center justify-between gap-4 text-xs text-[#556958]">
