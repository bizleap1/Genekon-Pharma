...
export default function CheckoutPage() {
  ...
  const [formData, setFormData] = useState<CheckoutFormData>({
    mobileNumber: user?.mobile || "9370102691",
    fullName: user?.name || "Prerna Sharma",
    addressLine: user?.address || "Flat 402, Green Valley Apartments, Katol Road",
                    ...
                    {!isEditingAddress ? (
                      <div className="p-4 rounded-xl border-2 border-[#559620] bg-[#F4FAF1] flex items-start justify-between">
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-[#1853A8] hover:underline cursor-pointer"
                        >
                          Modify
                        </button>
                      </div>
                      ...
                      <div className="p-4 rounded-xl border border-[#D5EAD0] bg-[#FAFCFA] space-y-3">
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-[#559620] text-white text-xs font-bold cursor-pointer"
                        >
                          Save Address
                        </button>
                      </div>
